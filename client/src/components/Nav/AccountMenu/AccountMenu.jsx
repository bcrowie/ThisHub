...
const AccountMenu = () => {
    ...
    return (
        <div className="account-menu">
            <ul>
                <li >
                    <Link className={`account-menu-link ${showAccountMenu && "link-active"}`} 
                ...
                <>
                    ...
                    <li>
                        <Link to='/my-account' 
                            className={`account-menu-link ${showAccountMenu && "link-active"}`}>
                                Account
                            <Icon path={mdiAccountDetails} title="Account Details" size={0.8} />
                        </Link>
                    </li>
                    <li>
                        <Link to='/settings' 
                    ...
                    <li>
                        <Link to='/' className={`account-menu-link ${showAccountMenu && "link-active"}`}
